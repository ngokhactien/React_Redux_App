                    ...
                    <div className="col-lg-2 ml-auto">
                        ...
                        <div className="social-section text-md-left">
                            <ul className="text-center">
                                <li>
                                    <a href='https://www.facebook.com/tiennk.020799/' className="btn-floating  btn-fb waves-effect waves-light">
                                        <i className="fa fa-facebook"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href='https://www.instagram.com/tiennk123/' className="btn-floating  btn-ins waves-effect waves-light">
                                ...
                                <li>
                                    <a href='https://www.youtube.com/channel/UCk3ua2a-Md6BMhInYCBuQPw' className="btn-floating  btn-yt waves-effect waves-light">
                        ...
                        <ul className="instagram-photos">
                            <li>
                                <div className="view overlay hm-white-slight z-depth-1">
                                    <img className="img-fluid" src="https://shortest.link/kQ8" alt="" />
                                    <a href>
                            ...
                            <li>
                                <div className="view overlay hm-white-slight z-depth-1">
                                    <img className="img-fluid" src="https://shortest.link/kQ9" alt="" />
                                    <a href>
                                        <div className="mask waves-light waves-effect waves-light"></div>
                                    </a>
                                </div>
                            ...
                            <li>
                                <div className="view overlay hm-white-slight z-depth-1">
                                    <img className="img-fluid" src="http://mdbootstrap.com/img/Photos/Avatars/img%20(10).jpg" alt="" />
                                    <a href>
                                        <div className="mask waves-light waves-effect waves-light"></div>
                                    </a>
                                </div>
                            ...
                            <li>
                                <div className="view overlay hm-white-slight z-depth-1">
                                    <img className="img-fluid" src="https://shortest.link/kQa" alt="" />
                                    <a href>
                                        <div className="mask waves-light waves-effect waves-light"></div>
                                    </a>
                                </div>
